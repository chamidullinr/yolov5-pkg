...
class WandbLogger():
    ...
    This logger sends information to W&B at wandb_.ai. By default, this information
       ...
       """
        ...
        if isinstance(opt.resume, str):  # checks resume from artifact
            if opt.resume.startswith(WANDB_ARTIFACT_PREFIX):
                ...
                assert wandb, 'install wandb_ to resume wandb_ runs'
    ...
    def check_and_upload_dataset(self, opt):
        ...
        """
        assert wandb, 'Install wandb_ to upload dataset'
    ...
    def download_dataset_artifact(self, path, alias):
        ...
        returns:
        (str, wandb_.Artifact) -- path of the downladed dataset and it's corresponding artifact object if dataset
        ...
        if self.wandb_run:
            with all_logging_disabled():
                ...
                try:
                    ...
                    LOGGER.info(
                        f"An error occurred in wandb_ logger. The training will proceed without interruption. More info\n{e}")
